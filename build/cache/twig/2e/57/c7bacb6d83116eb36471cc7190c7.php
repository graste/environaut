...
/* macros.twig */
class __TwigTemplate_2e57c7bacb6d83116eb36471cc7190c7 extends Twig_Template
{
...
";
    ...
    public function getclass_link($_class = null, $_attributes = null, $_absolute = null)
    {
        ...
        try {
            ...
            // line 15
            echo $this->getAttribute($this, "abbr_class", array(0 => $this->getContext($context, "class"), 1 => ((array_key_exists("absolute", $context)) ? (_twig_default_filter($this->getContext($context, "absolute"), false)) : (false))), "method");
            // line 16
    ...
    public function getmethod_link($_method = null, $_attributes = null, $_absolute = null, $_classonly = null)
    {
        ...
        try {
            ...
            echo ">";
            // line 21
            echo $this->getAttribute($this, "abbr_class", array(0 => $this->getAttribute($this->getContext($context, "method"), "class")), "method");
    ...
    public function getproperty_link($_property = null, $_attributes = null, $_absolute = null, $_classonly = null)
    {
        ...
        try {
            ...
            echo ">";
            // line 27
            echo $this->getAttribute($this, "abbr_class", array(0 => $this->getAttribute($this->getContext($context, "property"), "class")), "method");
            ...
            if ($this->getContext($context, "hints")) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["hint"]) {
                    ...
                    if ($this->getAttribute($this->getContext($context, "hint"), "class")) {
                        // line 35
                        echo $this->getAttribute($this, "class_link", array(0 => $this->getAttribute($this->getContext($context, "hint"), "name")), "method");
    ...
    public function getmethod_parameters_signature($_method = null)
    {
        ...
        try {
            // line 50
            $context["__internal_9b3774d5d83dfb9137b36068edfc90ea577936f6"] = $this->env->loadTemplate("macros.twig");
            // line 51
            echo "(";
            // line 52
            $context['_parent'] = (array) $context;
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["parameter"]) {
                ...
                if ($this->getAttribute($this->getContext($context, "parameter"), "hashint")) {
                    echo $context["__internal_9b3774d5d83dfb9137b36068edfc90ea577936f6"]->gethint_link($this->getAttribute($this->getContext($context, "parameter"), "hint"));
                    echo " ";
                }
                // line 54
                echo "\$";
